--Auto Get Fort, Lamp, Iceskate, Frostbite, Fan, Boxer, Elude, Counter, Bind, Glovel
...
loadstring(game:HttpGet('https://raw.githubusercontent.com/Pro666Pro/SlapBattlesTP/main/main.lua'))()
]])
end
